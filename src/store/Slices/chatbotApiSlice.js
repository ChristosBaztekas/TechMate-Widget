...
const chatbotApiSlice = createSlice({
  ...
  reducers: {
    ...
    setActiveQuestions: (state, action) => {
      ...
      console.log(
        '[setActiveQuestions] Active questions updated:',
        action.payload,
      )
    },
    ...
    setHiddenQuestions: (state, action) => {
      ...
      console.log(
        '[setHiddenQuestions] Hidden questions updated:',
        action.payload,
      )
    },
    ...
    resetMessages: (state, action) => {
      ...
      if (action.payload?.question) {
        ...
        console.log(
          '[resetMessages] Added selected question:',
    ...
    builder
      ...
      .addCase(fetchAllQuestions.fulfilled, (state, action) => {
        ...
        if (state.activeQuestions.length === 0) {
          ...
          console.log(
            '[fetchAllQuestions.fulfilled] Updated state.messages (no active question):',
            state.messages,
          )
        } else {
          ...
          console.log(
            '[fetchAllQuestions.fulfilled] Active question present, greeting text updated:',
            state.messages[0],
          )
        }
        // Store the first 3 questions for notifications permanently.
        state.notificationQuestions = (action.payload.questions || []).slice(
          0,
          3,
        )
        console.log(
          '[fetchAllQuestions.fulfilled] notificationQuestions:',
          state.notificationQuestions,
        )
      })
      ...
      .addCase(fetchUserQuestion.pending, (state, action) => {
        ...
        console.log(
          '[fetchUserQuestion.pending] Added placeholder message:',
      ...
      .addCase(fetchUserQuestion.fulfilled, (state, action) => {
        ...
        console.log(
          '[fetchUserQuestion.fulfilled] Updated last message:',
          lastMessage,
        )
      })
      ...
      .addCase(fetchGivenQuestion.pending, (state) => {
        ...
        console.log(
          '[fetchGivenQuestion.pending] Added placeholder message:',
          state.messages[state.messages.length - 1],
        )
      })
      .addCase(fetchGivenQuestion.fulfilled, (state, action) => {
        ...
        lastMessage.questions = action.payload.follow_up
        console.log(
          '[fetchGivenQuestion.fulfilled] Updated last message:',
          lastMessage,
        )
      })
